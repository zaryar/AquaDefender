...
public class PlayerMovementController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (GameObject.Find("IceBox")!= null) iceBox = GameObject.Find("IceBox").GetComponent<IceBox>();
        ...
        {   
            ...
            if(weapon == 1 && iceBox.swordUnlocked) {
    ...
    private void Update()
    {
        ...
        _characterController.SimpleMove(_Movement * (movementSpeed + GameController.instance.MovespeedFactor) * (player.transform.position.y < 1.2 ? speedModifier : 1));
    }
